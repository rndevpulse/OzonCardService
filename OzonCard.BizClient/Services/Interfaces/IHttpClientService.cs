...
namespace OzonCard.BizClient.Services.Interfaces
{
    public interface IHttpClientService
    {
        ...
        Task<bool> DelCategotyCustomer(Session access_session, Guid iikoBizId, Guid organizationId, Guid categoryId);
        ...
        Task<IEnumerable<TransactionsReport>> GerTransactionsReport(Session session, Guid organizationId, string dateFrom, string dateTo);
