...
namespace OzonCard.Database.Migrations.SqlServer.Migrations.Operational
{
    ...
    [Migration("20251202121700_fixMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OzonCard.Common.Domain.Customers.Customer", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CreatedBiz")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("OzonCard.Common.Domain.Customers.CustomerVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("customers_visits", (string)null);
                });
            ...
            modelBuilder.Entity("OzonCard.Common.Domain.Customers.Customer", b =>
                {
                    ...
                    b.OwnsMany("OzonCard.Common.Domain.Customers.CustomerCategory", "Categories", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("customers_categories", (string)null);
