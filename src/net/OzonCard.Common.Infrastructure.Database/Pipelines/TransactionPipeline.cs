...
namespace OzonCard.Common.Infrastructure.Database.Pipelines;
    ...
    where TRequest : IRequest<TResponse>
{
    ...
    public TransactionPipeline(ITransactionManager transactions,
        ILogger<TransactionPipeline<TRequest, TResponse>> logger)
    {
