...
var TaskStore = /** @class */ (function () {
    ...
    TaskStore.prototype.onCancelTask = function (taskId) {
        return __awaiter(this, void 0, void 0, function () {
            var t;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        t = this.tasks.filter(function (t) { return t.taskId === taskId; })[0];
                        t.isCancel = true;
                        this.tasks = this.tasks.filter(function (t) { return t.taskId !== taskId; });
                        this.tasks.push(t);
                        localStorage.setItem('tasks', JSON.stringify(this.tasks));
                        return [4 /*yield*/, TaskService_1.default.cancelTask(taskId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
