...
export const API_URL = 'https://localhost:8520/api'
// export const API_URL = 'https://ozon.kolur.keenetic.link/api'
// export const API_URL = 'https://ozon.pulse2.keenetic.link/api'
