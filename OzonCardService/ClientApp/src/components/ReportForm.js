...
var ReportForm = function () {
    ...
    var _f = react_1.useState(new Date(new Date().setDate(1))), dateFrom = _f[0], setDateFrom = _f[1];
    var _g = react_1.useState(new Date()), dateTo = _g[0], setDateTo = _g[1];
    ...
    return (React.createElement("div", null,
        React.createElement("h1", null, "\u041E\u0442\u0447\u0435\u0442\u044B"),
        React.createElement("div", { className: "form-group col-md-6" },
            ...
            React.createElement("button", { className: "btn-primary button", onClick: reportFromBiz }, "\u0412\u044B\u0433\u0440\u0443\u0437\u0438\u0442\u044C"))));
};
