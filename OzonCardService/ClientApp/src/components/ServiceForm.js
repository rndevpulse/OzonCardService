...
var ServiceForm = function () {
    ...
    var formNewUser = function () { return (React.createElement("li", null,
        React.createElement("dt", null,
            ...
            React.createElement("button", { className: "button", onClick: createUser }, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C")),
    ...
    var formNewOrganization = function () { return (React.createElement("li", null,
        React.createElement("dt", null,
            ...
            React.createElement("button", { className: "button", onClick: createOrganization }, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C")),
        React.createElement("dd", null))); };
        ...
        React.createElement("ul", null, users && users.filter(function (u) { return u.mail.includes(filterUserEmail); }).map(function (u) {
            return (React.createElement("li", { key: u.id },
                React.createElement("dt", null,
                    ...
                    React.createElement("span", null,
                        React.createElement("button", { className: "button", onClick: function () { return delUserForOrganization(u.id); } }, "\u0423\u0431\u0440\u0430\u0442\u044C"),
                        React.createElement("button", { className: "button", onClick: function () { return addUserForOrganization(u.id); } }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C"))),
                React.createElement("dd", null,
    ...
    return (React.createElement("div", { className: "" },
        React.createElement("h1", { className: "center form-group col-md-12" }, "\u0421\u0435\u0440\u0432\u0438\u0441"),
